...
const AddCarModal = ({ visible, onClose, editData = null }) => {
  ...
  useEffect(() => {
    if (visible) {
      if (editData) {
        ...
        setTenXe(editData.ten_xe_ph53550 || '');
        setMauSac(editData.mau_sac_ph53550 || '');
        setGiaBan(editData.gia_ban_ph53550 ? String(editData.gia_ban_ph53550) : '');
        setMoTa(editData.mo_ta_ph53550 || '');
        setHinhAnh(editData.hinh_anh_ph53550 || '');
      } else {
  ...
  const handleSubmit = () => {
    ...
    const carData = {
      ten_xe_ph53550: tenXe,
      mau_sac_ph53550: mauSac,
      gia_ban_ph53550: parseFloat(giaBan),
      mo_ta_ph53550: moTa,
      hinh_anh_ph53550: hinhAnh
    };
