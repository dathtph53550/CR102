  ...
  useEffect(() => {
    if (listId) {
      ...
      if (listToEdit) {
        setFormData({
          id: listToEdit.id,
          ph53550_hoten: listToEdit.ph53550_hoten,
          ph53550_mon_thi: listToEdit.ph53550_mon_thi,
          ph53550_ngay_thi: listToEdit.ph53550_ngay_thi,
          ph53550_ca_thi: listToEdit.ph53550_ca_thi.toString(),
          ph53550_hinh_anh: listToEdit.ph53550_hinh_anh
        });
      } else {
